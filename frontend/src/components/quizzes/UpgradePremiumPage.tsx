...
interface UpgradePremiumPageProps {
  isPremiumUser: boolean // Thêm prop để kiểm tra trạng thái Premium của người dùng
}

export default function UpgradePremiumPage({ isPremiumUser }: UpgradePremiumPageProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <h1 className="text-lg font-semibold text-gray-900">Quizz Membership</h1>
              </Link>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-4xl mx-auto space-y-10">
        {isPremiumUser ? (
          /* State: User already has Premium */
          <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
            <CardHeader className="pb-6">
              ...
              <CardDescription className="text-xl text-gray-700 max-w-2xl mx-auto">
                Thank you for being a part of our Premium community. Enjoy all the exclusive benefits!
              </CardDescription>
              <Badge className="mx-auto mt-4 bg-gradient-to-r from-green-500 to-blue-500 text-white text-lg px-4 py-2">
                <Crown className="w-4 h-4 mr-2" />
                Premium Membership Active
              </Badge>
            </CardHeader>
            <CardContent className="pb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Your Exclusive Benefits:</h2>
              ...
              <Link to="/">
                <Button className="h-14 px-10 text-lg font-semibold bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1 mt-8">
                  <Home className="w-5 h-5 mr-3" />
                  Explore Premium Quizzes
                </Button>
              </Link>
            </CardContent>
          </Card>
          ...
          <>
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardHeader className="pb-6">
                ...
                <CardDescription className="text-xl text-gray-700 max-w-2xl mx-auto">
                  Go Premium with Quizz to access exclusive features, detailed insights, and an ad-free experience.
                </CardDescription>
              </CardHeader>
              <CardContent className="pb-8">
                <Link to="/payment">
            ...
            <Card className="text-center border-0 shadow-lg bg-white/80 backdrop-blur-sm">
              <CardContent className="py-8">
                ...
                <p className="text-lg text-gray-700 mb-6">
                  Join thousands of learners who are already accelerating their progress with Quizz Premium.
                </p>
                <Link to="/payment">
                  <Button className="h-14 px-10 text-lg font-semibold bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white shadow-lg transition-all duration-300 ease-in-out transform hover:-translate-y-1">
