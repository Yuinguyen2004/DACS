...
export default function QuizTypeSelectorPage() {
  ...
  const quizTypes: QuizTypeOption[] = [
    ...
    {
      type: "ai-import",
      title: "Import từ File (AI)",
      description:
        "Upload file Word hoặc PDF, AI tự động phân tích và tạo câu hỏi. Tiết kiệm thời gian, phù hợp cho việc chuyển đổi tài liệu có sẵn. Premium feature.",
      icon: <Sparkles className="w-12 h-12" />,
      supportsImage: false,
    },
  ]

  const handleSelectType = (type: "basic" | "image" | "ai-import") => {
    if (type === "ai-import") {
      navigate('/import-quiz')
      return
    }
